...
def template_model(Ts):
    ...
    #
    # x(t)     = x(t) + v(t)cos(theta) * Ts
    # y(t)     = y(t) + v(t)sen(theta) * Ts
    # theta(t) = theta(t) + w(t) * Ts
    #
    ...
    f_1 = vertcat( x + v * cos(theta) )
    f_2 = vertcat( y + v * sin(theta) )

    model.set_rhs('x', f_1)
    model.set_rhs('y', f_2)
    model.set_rhs('theta', theta + w)
